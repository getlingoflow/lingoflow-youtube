...
export default defineConfig({
  ...
  define: {
    ...
    "process.env.REACT_APP_RULESURL": JSON.stringify("https://raw.githubusercontent.com/nickyc975/lingoflow-rules/main/rules.json"),
    "process.env.REACT_APP_RULESURL_ON": JSON.stringify(""),
    "process.env.REACT_APP_RULESURL_OFF": JSON.stringify(""),
    "process.env.REACT_APP_HOMEPAGE": JSON.stringify("https://github.com/nickyc975/youtube-dual-subtitles-pro"),
